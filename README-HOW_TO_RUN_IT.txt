__________________________ENGLISH_________________________________________________________________________________________
To run different models you can edit the txt "currentFile.txt" and add the model's path for a obj file: 
Example: data/PandaNormal/PandaNormal.obj

Be careful to not add an break line in the end of the file!


Different paths are available on "file.txt" doc, you can copy and paste one of these paths on "currentFile.txt"
...
Exemplo: data/PandaNormal/PandaNormal.obj

Cuidado para não dar enter e criar uma linha vazia no final do arquivo!

Caminhos de objetos diferentes estão no arquivo "file.txt", você pode copiar e colar no arquivo "currentFile.txt".
