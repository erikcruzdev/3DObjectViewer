...
int main()
{
   ...
   //  Model ourModel(FileSystem::getPath("data/TenisNormal/TenisNormal.obj"));
    ...
    {
        FileSystem::getPath("data/textures/skybox/right.jpg"),
        FileSystem::getPath("data/textures/skybox/left.jpg"),
        FileSystem::getPath("data/textures/skybox/top.jpg"),
        FileSystem::getPath("data/textures/skybox/bottom.jpg"),
        FileSystem::getPath("data/textures/skybox/front.jpg"),
        FileSystem::getPath("data/textures/skybox/back.jpg")
    };
